...
public class ConfigController implements Initializable {
    ...
    public void askPrev(ActionEvent actionEvent) throws IOException, SQLException {
        ...
        LocalDate modifiedDate = myDate.plusMonths(1).plusDays(10);
        testAutoData.date = modifiedDate.toString();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        DButils.getExtraOptional(testAutoData.idAuto);

        if (testAutoData.lista.isEmpty()) {
            System.out.println("VUOTO");
        } else {
            divide = testAutoData.lista.split("£");
    ...
    public void setPrice1(ActionEvent actionEvent) {
    ...
    public void setPrice2(ActionEvent actionEvent) {
    ...
    public void setPrice3(ActionEvent actionEvent) {
    ...
    public void setPrice4(ActionEvent actionEvent) {
    ...
    public void setPrice5(ActionEvent actionEvent) {
